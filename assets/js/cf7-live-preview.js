...
(function($) {
  ...
  $(document).ready(function() {
    ...
    if (typeof window.cf7lp_data.live_preview_metabox === "undefined")
      return
    ...
    window.addEventListener('message', function(event) {
      if (event.origin !== window.origin || !event.data.hasOwnProperty('cf7lp'))
        return
    ...
    // Change option
    $('.cf7lp-option').on('change input', function(e){
